...
_TW: dict[str, str] = {
    ...
    # 精密沖壓件 / 鉸鏈（Apple 折疊機供應鏈）
    # 2026-09-18 新增（來源：EP567 資料稽核事故——「兆利」被誤記成 3376.TW，
    # 3376 其實是新日興；兩家都做 Apple 折疊機鉸鏈，講者口語常把兩者代號講混
    # （EP567/EP591/EP696 三集都出現過），加進字典鎖住正確值、蓋掉 LLM 猜測）。
    "新日興": "3376.TW",
    # 光通訊
    "波若威": "3163.TWO",
    ...
    "金山電": "8042.TWO",
    # 2026-09-18 新增（同上「新日興」註記——EP567 把「兆利」誤記成 3376.TW，
    # 3376 是新日興；兆利正確代號查證見 nstock/Yahoo股市/鉅亨網等多站一致標示
    # 3548.TWO，上櫃，不是 .TW）。
    "兆利": "3548.TWO",
